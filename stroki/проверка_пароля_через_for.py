...
if count_zaglav_bukv == 0:  # если заглавных букв нет, то
    text += 'добавить 1 заглавную букву'  # добавляем в текст сообщение

if count_strochn_bukv == 0:  # если строчных букв нет, то
    text += 'добавить 1 строчную букву'  # добавляем в текст сообщение

if count_cifr == 0:  # если цифр нет, то
    text += 'добавить 1 цифру'  # добавляем в текст сообщение

if count_spec_simvol == 0:  # если спецсимволов нет, то
    text += 'добавить 1 спецсимвол'  # добавляем в текст сообщение

if count_error_symvols != 0:  # если есть хотя бы 1 некорректный символ
