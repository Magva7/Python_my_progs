...
# сколько получилось целых часов, т.е.
# сколько часов прошло - делим количество секунд на 3600 и считаем остаток от 24
result_hours = (secund_input // 3600) % 24

# дальше выводим количество минут - разбиваем на 2 символа, десятки и единицы, т.к. если у нас
# целых минут получится меньше 10, то в первом символе, где десятки, должен быть ноль

# сколько получилось целых минут - делим количество введенных секунд на 60 и считаем остаток от 60
